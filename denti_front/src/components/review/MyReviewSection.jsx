...
import { deleteReview, getMyReviews, toggleReviewLike } from "../../api/reviewAPI";
...
function MyReviewSection({ currentUserId }) {
    ...
    const loadReviews = useCallback(async () => {
        ...
        try {
            ...
            const response = await getMyReviews(currentUserId, page, 5);
                            ...
                            {editingReview?.reviewId === review.reviewId ? (
                                ...
                                <>
                                    ...
                                    <button
                                        ...
                                        onClick={() => navigate(`/repair-shops/${review.shopId}`)}
                                    >
