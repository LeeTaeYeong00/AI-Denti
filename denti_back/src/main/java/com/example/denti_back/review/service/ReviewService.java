...
public class ReviewService {
    ...
    public ShopReviewResponse getShopReviews(
        ...
        Page<Review> reviewPage =
                reviewRepository.findByReservation_Shop_ShopId(
                        shopId,
                        pageable
                );
        ...
        List<ReviewResponse> reviews = reviewPage
                ...
                .stream()
                .map(review ->
                        toReviewResponse(review, currentUserId))
                .toList();

        ShopReviewResponse response = new ShopReviewResponse();
        response.setShopId(shopId);
        response.setAverageRating(
                reviewRepository.findAverageRatingByShopId(shopId)
        );
        response.setReviewCount(
                reviewRepository.countByReservation_Shop_ShopId(shopId)
        );
    ...
    public ReviewResponse updateReview(
        ...
        return toReviewResponse(updatedReview, currentUserId);
    }
    ...
    public void deleteReview(
        ...
        reviewLikeRepository.deleteByReview_ReviewId(reviewId);
    ...
    private ReviewResponse toReviewResponse(
        ...
        response.setShopId(reservation.getShop().getShopId());
        response.setShopName(reservation.getShop().getName());

        response.setWriterId(reservation.getUser().getUserId());
        ...
        ReviewReplyResponse replyResponse =
                reviewReplyRepository
                        .findByReview_ReviewId(review.getReviewId())
        ...
        response.setLikeCount(
                reviewLikeRepository.countByReview_ReviewId(
                        review.getReviewId()
                )
        );
    ...
    private ReviewImageResponse toImageResponse(
        ...
        response.setReviewImageId(image.getReviewImageId());
